...
if ~isfield(P,'pre_up_down')
    P.pre_up_down = 1;
    P.pre_imgPath = '';
end

% Note, don't split cell structure in 2 lines with '...'.
fieldNames = {'feedbackType', 'condition', 'dispValue', 'Reward', 'displayStage','displayBlankScreen', 'iteration', 'up_down','imgPath'};
defaultFields = {'', 0, 0, '', '', '', 0, P.pre_up_down,P.pre_imgPath};
% disp(displayData)
...
P.pre_up_down = up_down;
P.pre_imgPath = imgPath;
        ...
        switch condition
            ...
            case 2 % Regualtion
                ...
                Screen('FillOval', P.Screen.wPtr, [255 255 255], ...
                    [floor(P.Screen.w/10-P.Screen.w/200), ...
                    floor(P.Screen.h/2-P.Screen.w/200), ...
                    floor(P.Screen.w/10+P.Screen.w/200), ...
                    floor(P.Screen.h/2+P.Screen.w/200)]);
                % draw top target bar
                Screen('DrawLines', P.Screen.wPtr, ...
                    [floor(P.Screen.w/10-P.Screen.w/20), ...
                    floor(P.Screen.w/10+P.Screen.w/20); ...
                    floor(P.Screen.h/10), floor(P.Screen.h/10)], ...
                    P.Screen.lw, [255 0 0]);
                % draw bottom target bar
                Screen('DrawLines', P.Screen.wPtr, ...
                    [floor(P.Screen.w/10-P.Screen.w/20), ...
                    floor(P.Screen.w/10+P.Screen.w/20); ...
                    floor(P.Screen.h-P.Screen.h/10), floor(P.Screen.h-P.Screen.h/10)], ...
                    P.Screen.lw, [0 0 255]);
                % draw activity bar
                Screen('DrawLines', P.Screen.wPtr, ...
                    [floor(P.Screen.w/10-P.Screen.w/20), ...
                ...
                % draw arrow
                switch(P.pre_up_down)
                    case -1
                    Screen('DrawLines', P.Screen.wPtr, ...
                        [floor(P.Screen.w/5), ...
                        floor(P.Screen.w/5); ...
                        floor(P.Screen.h/2-P.Screen.h/10), ...
                        floor(P.Screen.h/2+P.Screen.h/10)], P.Screen.lw-1, [150 150 150]);
                    Screen('DrawLines', P.Screen.wPtr, ...
                        [floor(P.Screen.w/5), ...
                        floor(P.Screen.w/5-P.Screen.w/40); ...
                        floor(P.Screen.h/2+P.Screen.h/10), ...
                        floor(P.Screen.h/2+P.Screen.h/10-P.Screen.w/40)], P.Screen.lw, [150 150 150]);
                    Screen('DrawLines', P.Screen.wPtr, ...
                        [floor(P.Screen.w/5), ...
                        floor(P.Screen.w/5+P.Screen.w/40); ...
                        floor(P.Screen.h/2+P.Screen.h/10), ...
                ...
                %draw image
                imRect = [floor(P.Screen.w-P.Screen.w/20-P.Screen.h*16/15) floor(P.Screen.h/10) floor(P.Screen.w-P.Screen.w/20) floor(P.Screen.h*9/10)];
                if ~strcmp(P.pre_imgPath,'')
                    Screen('FillRect',P.Screen.wPtr,[0 0 0],imRect);
                    img = imread(P.pre_imgPath);
                    img = imresize(img,P.Screen.h/600);
                    file_img = Screen('MakeTexture',P.Screen.wPtr,img);
                    Screen('DrawTexture',P.Screen.wPtr,file_img,[],imRect);
                end
        end
